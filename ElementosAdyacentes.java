...
// Comprobar si un número dado aparece en posiciones impares o pares en un arreglo.
 
public class ElementosAdyacentes {

    public static void main(String[] args) {
        
        int[] numeros = {200, 100, 200, 700, 200, 500, 200};
        
        System.out.println(validarAparicionDato(numeros, 200)); // true
        
        numeros = new int[]{200, 100, 200, 100, 200, 100, 1000};
